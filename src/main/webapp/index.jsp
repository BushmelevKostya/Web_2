...
<header>
    <div class="header gradient-black">Bushmelev Kostya, Group P3218, Variant 557474</div>
</header>
...
<div class="content">
        ...
        <form method="POST" action="controller">
            ...
            <div class="y input-text-block">
                <label for="text" class="text-label">
                    <span>Область определения: [-5, ..., 3]</span>
                </label>
    ...
    <div class="tasks">
        <ul>
            ...
            <li class="li-tasks5">
                Интерактивный элемент, содержащий изображение области на координатной плоскости (в соответствии с
                вариантом
                задания) и реализующий следующую функциональность:
                Если радиус области установлен, клик курсором мыши по изображению должен обрабатываться
                JavaScript-функцией,
                ...
                координат
                точки;
                После проверки факта попадания точки в область изображение должно быть обновлено с учётом результатов
                этой
...
<div class="view">
    ...
    <div class="data-table" id="main-data-table">
        <table border="1" class="data-table" id="data-table">
            ...
            <tbody id="data-body" class="data-body">
            <%
...
<script src="script/draw-dots.js"></script>
